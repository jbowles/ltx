...
\setlength{\headsep}{0.3in}     % space between header and text
...
\chead{\scshape \scriptsize \ttfamily Draft Last Updated: \today}
...
\section{\textsc{Personal\\ Information}}\begin{wrapfigure}{R}{0.2\textwidth}
			 \vspace{-1cm}
       % \begin{center}
        %\includegraphics[width=0.3\textwidth]{closeupred}
        %\end{center}
      %\vspace{-1cm}
    %\end{wrapfigure} 
Born: May 23, 1976\\
